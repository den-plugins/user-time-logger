...
#    issue_clone = @issue.clone
  ...
  def destroy
    ...
    journal = @time_entry.init_journal(User.current, @time_entry.comments)
    @time_entry.destroy
    journal.details << JournalDetail.new(:property => 'timelog', :prop_key => 'hours', :old_value => @time_entry.hours)
    journal.save
